...
class Daily_Duty_Schedule(object):
	...
	def __init__(self, date, day_of_week, evening : list, morning : list, afernoon : list):
		...
		self.date = Util.format_date(date)
		self.day_of_week = day_of_week
		self.evening = Util.format_name(evening)
		self.morning = Util.format_name(morning)
		self.afernoon = Util.format_name(afernoon)
	...
	# 	return list(map(lambda n:n[0], names))
